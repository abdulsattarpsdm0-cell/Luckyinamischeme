            ...
            {isLoggedIn ? (
              <div className="flex items-center space-x-4 bg-slate-50 p-3 md:p-4 rounded-3xl border border-slate-100">
                <div className="text-center px-2 md:px-4">
                  ...
                  <span className="text-xs md:text-lg font-black text-emerald-600">Rs {(user.walletBalance || 0).toLocaleString()}</span>
                </div>
                ...
                <div className="text-center px-2 md:px-4">
                  ...
                  <span className="text-xs md:text-lg font-black text-amber-500">Rs {(user.totalWinnings || 0).toLocaleString()}</span>
                </div>
              </div>
            ) : (
                  ...
                  <div className="w-full lg:w-3/5 text-center lg:text-left space-y-4 md:space-y-6">
                    ...
                    <div className="animate-in slide-in-from-bottom-4 duration-700 delay-200">
                       <p className="text-base md:text-xl text-slate-300 font-bold leading-relaxed max-w-md mx-auto lg:mx-0">
                        First Prize: <span className="text-emerald-400 font-black">{plan.prizeName || `Rs ${(plan.prizePerWinner || 0).toLocaleString()}`}</span>
                      </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pb-12">
        <div className="mb-16 last:mb-0">
          <div className="flex justify-between items-end mb-10 text-center md:text-left">
            <div>
              <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tight">All Lotteries</h2>
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-sm font-black text-indigo-600">{plan.prizeName || `Rs ${(plan.prizePerWinner || 0).toLocaleString()}`}</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-8">
                      ...
                      <div className="flex justify-between items-center text-[11px] font-bold text-slate-500">
                        ...
                        <span className="text-indigo-600 font-black">{(plan.totalTokens || 0).toLocaleString()} Spots</span>
                      </div>
